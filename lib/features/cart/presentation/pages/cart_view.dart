        ...
        body: BlocConsumer<CartCubit, CartState>(
          ...
          builder: (context, state) {
            if (state is CartSuccessState) {
              var books = context.read<CartCubit>().response?.data?.cartItems ?? [];
                        ...
                        child: ListView.separated(
                            ...
                            itemBuilder: (context, index) {
                              return CartBody(
                                ...
                                onAdd: () {
                                  if( (books[index].itemQuantity?? 0) < (books[index].itemProductStock?? 0)){
                                    
                                  
                                  context.read<CartCubit>()
                                  .updateCart( books[index].itemId?? 0, (books[index].itemQuantity?? 0)+1);}
                                  else{
